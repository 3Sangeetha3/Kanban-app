...
<head>
    ...
    <meta name="description" content="Join Kanban - Your powerful task management solution">
            ...
            <div class="flex flex-col md:flex-row min-h-[500px]">
                ...
                <div class="w-full md:w-1/2 p-8 flex items-center justify-center" style="background-color: var(--color-tertiary);">
                    <div>
                        ...
                        <p class="text-gray-300 mt-6 text-center">Streamline your projects with our intuitive Kanban board</p>
                    </div>
                </div>
                ...
                <div class="w-full md:w-1/2 p-8" style="background-color: var(--color-secondary);">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-300">Join thousands of teams already using Kanban</p>
                    </div>
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="text-center text-sm text-gray-300">
                            ...
                            <a href="#" class="text-accent hover:underline" style="color: var(--color-accent);">Sign In</a>
                        </div>
                    </form>
                </div>
            </div>
